...
icon = pygame.image.load("gamedata/hangman6.png")
...
for i in range(7):
    image = pygame.image.load(f"gamedata/hangman{i}.png")
    IMAGES.append(image)
...
# Fonts
btn_font = pygame.font.SysFont('Jokerman', 30)
letter_font = pygame.font.SysFont('Bradley Hand ITC', 60)
game_font = pygame.font.SysFont('Chiller', 80)
